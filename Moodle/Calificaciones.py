...
# Equivalente de taller 1 y 2 con escala de 0 a 10 (20% seguimiento)
T12 = 'max(' + ';'.join([T1, T2]) + ')'
...
=(0,9*min((0,2*max((([[Q1]]+[[B1]]/10)+[[Q2]]);(([[Q1]]+[[B1]]/10)+[[T1]]);([[Q2]]+[[T1]]))+0,2*max(([[Q3]]+([[Q4]]+[[B4]]/10));([[Q3]]+max([[T1]];[[T2]]));(([[Q4]]+[[B4]]/10)+max([[T1]];[[T2]])))+0,1*max([[T1]];[[T2]]))+floor((0,2*max((([[Q1]]+[[B1]]/10)+[[Q2]]);(([[Q1]]+[[B1]]/10)+[[T1]]);([[Q2]]+[[T1]]))+0,2*max(([[Q3]]+([[Q4]]+[[B4]]/10));([[Q3]]+max([[T1]];[[T2]]));(([[Q4]]+[[B4]]/10)+max([[T1]];[[T2]])))+0,1*max([[T1]];[[T2]]))/3)*([[MM]]+[[SA]]);5)+0,1*5*floor((0,2*max((([[Q1]]+[[B1]]/10)+[[Q2]]);(([[Q1]]+[[B1]]/10)+[[T1]]);([[Q2]]+[[T1]]))+0,2*max(([[Q3]]+([[Q4]]+[[B4]]/10));([[Q3]]+max([[T1]];[[T2]]));(([[Q4]]+[[B4]]/10)+max([[T1]];[[T2]])))+0,1*max([[T1]];[[T2]]))/3)*[[SM]])/(0,9+0,1*floor((0,2*max((([[Q1]]+[[B1]]/10)+[[Q2]]);(([[Q1]]+[[B1]]/10)+[[T1]]);([[Q2]]+[[T1]]))+0,2*max(([[Q3]]+([[Q4]]+[[B4]]/10));([[Q3]]+max([[T1]];[[T2]]));(([[Q4]]+[[B4]]/10)+max([[T1]];[[T2]])))+0,1*max([[T1]];[[T2]]))/3)*[[SM]])
'''
