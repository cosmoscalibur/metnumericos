...
\ (en la entrada y salida de sus códigos será el separador por defecto del lenguaje)% {Taller}
.
...
\ (su código debe estar en capacidad de detectar posibles casos fallidos)% {Taller}
.
